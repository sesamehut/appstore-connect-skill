...
export default defineConfig(
  ...
  // human mistake there. plugin/ is the committed, byte-stable plugin payload
  // (generated by package:plugin, including the esbuild CLI bundle) — its
  // formatting is owned by the generator, never linted. .debug-output/ is the
  // gitignored ad-hoc debug scratch area (see CLAUDE.md) — never linted.
  globalIgnores([
    "dist/",
    "plugin/",
    "coverage/",
